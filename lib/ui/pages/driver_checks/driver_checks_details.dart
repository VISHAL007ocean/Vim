...
class DriverCheckDetails extends StatefulWidget {
  @override
  _DriverChecksDetailsState createState() => _DriverChecksDetailsState();
}

class _DriverChecksDetailsState extends State<DriverCheckDetails> {
