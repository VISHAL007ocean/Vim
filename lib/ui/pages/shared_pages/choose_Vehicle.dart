...
class ChooseVehiclePage extends StatefulWidget {
  ...
  final int vehCheck;
  final int fltCheck;
  ChooseVehiclePage(this.nextPage, this.vehCheck, this.fltCheck);

  @override
  _ChooseVehicleState createState() => new _ChooseVehicleState();
}

class _ChooseVehicleState extends State<ChooseVehiclePage> {
                ...
                setState(() {
                  if (widget.vehCheck == 1) {
                    if (widget.fltCheck == 0) {
                      //driver and other
                      checkVehicleStatus(
                              data[i]["registration"].toString(), context)
                          .then((value) {
                        if (value == true) {
