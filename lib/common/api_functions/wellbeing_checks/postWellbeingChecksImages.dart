...
Future postWellbeingsChecksImages(BuildContext context, var id,
    List<CreateWellbeingCheckAnswers> answers, List<dynamic> questions) async {
  String messageTitle;
  String message;
  ...
  var token;
  var wellbeingCheckId = id.toString();
  ...
  try {
    ...
    formData = FormData.fromMap(
        {"Id": wellbeingCheckId, "ImageData": imageData, "Files": mapEntry});
    formData.files.addAll(mapEntry);
    var response = await dio
        .post(
          BASE_URL + "/api/wellbeingchecks/UploadImages",
          data: formData,
        )
