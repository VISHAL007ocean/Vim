...
Future postVerificationsChecksImages(
  ...
  var token;
  var verificationCheckId = id.toString();
  ...
  try {
    ...
    formData = FormData.fromMap(
        {"Id": verificationCheckId, "ImageData": imageData, "Files": mapEntry});
    formData.files.addAll(mapEntry);
    var response = await dio
        .post(
          BASE_URL + "/api/verificationchecks/UploadImages",
          data: formData,
        )
